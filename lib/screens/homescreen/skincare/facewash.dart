...
class _FacewashState extends State<Facewash> {
  final List<Products> products = [
    ...
    Products(
      ...
      images: ['assets/facewashthree.jpg'],
      rating: 4.0,
      boughtCount: "30k+",
    ...
    Products(
      ...
      images: ['assets/facewashfour.jpg'],
      rating: 4.0,
      boughtCount: "30k+",
    ...
    Products(
      ...
      images: ['assets/facewashfive.jpg'],
      rating: 4.0,
      boughtCount: "30k+",
