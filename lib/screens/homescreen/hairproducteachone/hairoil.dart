...
class _HairoilState extends State<Hairoil> {
  ...
  final List<Products> products = [
   ...
   Products(
      name: "Wow Amla Hair Oil",
     
      description:
          "Hair oil repairs hair by restoring moisture, strengthening the cuticle, and reducing breakage",
        features:
          'uitable for all scalp types, this scalp moisturizer is for anyone looking to fight oil-free hydration without any greasy shine.',
      images: ['assets/amla.jpg'],
      rating: 4.5,
      boughtCount: "50k+",
 ...
 Products(
    ...
    Products(
      ...
      description:
       ...
       features:
          'uitable for all scalp types, this scalp moisturizer is for anyone looking to fight oil-free hydration without any greasy shine.', images: ['assets/sept.jpg'],
      rating: 4.5,
      boughtCount: "50k+",
