...
class Keshpallavi extends StatefulWidget {
  const Keshpallavi({super.key});

  @override
  State<Keshpallavi> createState() => _KeshpallaviState();
}

class _KeshpallaviState extends State<Keshpallavi> {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              "• Provides long-lasting moisture to dry hair",
                              style: TextStyle(fontWeight: FontWeight.w500),
                            ),
                            Text(
