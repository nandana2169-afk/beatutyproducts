...
class Loreal extends StatefulWidget {
  const Loreal({super.key});

  @override
  State<Loreal> createState() => _LorealState();
}

class _LorealState extends State<Loreal> {
  List<String> listimage = [
    'assets/loreal.jpg',
    'assets/lorealadverone.jpg',
    'assets/lorealadvertwo.jpg',
  ];
  ...
  Widget build(BuildContext context) {
    ...
    Navigator.pop(context,MaterialPageRoute(builder: (context)=>Haircareselect()));
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 6),
                      Text("(50K+ bought)", style: TextStyle(color: Appcolor.backcolor)),
                    ],
                  ),
                    ...
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  color: Appcolor.backcolor, fontSize: 13),
                            ),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("• Hair Type  All Hair Types",
                                style: TextStyle(fontWeight: FontWeight.w500)),
                            Text("• Scalp Type All Scalp Types",
                                style: TextStyle(fontWeight: FontWeight.w500)),
                            Text("• Formulation Liquid",
                                style: TextStyle(fontWeight: FontWeight.w500)),
                            Text("• Preference Paraben Free",
                                style: TextStyle(fontWeight: FontWeight.w500)),
                          ],
                        ),
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.delivery_dining, color: Colors.green, size: 22),
